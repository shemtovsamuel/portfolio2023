        ...
        <div className="row">
          <div className="col-lg-5 col-xl-4 m-15px-tb">
            <div className="contact-info">
              <h4>Aimeriez-vous échanger avec moi ?</h4>
              <p>
                À l'écoute d'une nouvelle opportunité, je suis disponible pour
                découvrir vos projets.
              </p>
              <ul>
                <li className="media">
                  <i className="ti-map" />
                  <span className="media-body">Paris, France</span>
                </li>
                <li className="media">
                  <i className="ti-email" />
                  <span className="media-body">shemtovsamuel@gmail.com</span>
                </li>
              </ul>
            </div>
          </div>
