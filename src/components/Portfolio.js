        ...
        <div className="portfolio-content grid-gutter-lg grid-col-3 lightbox-gallery">
              ...
              <div className="portfolio-box-01">
                ...
                <div className="portfolio-img" style={{ borderRadius: "25%" }}>
                  ...
                  <div className="portfolio-icon">
                    <a href="/area" className="gallery-link">
          ...
          <div className="grid-item photoshop">
            <div className="portfolio-box-01">
              ...
              <div className="portfolio-img">
                <img src="static/img/portfolio/inveskal.png" title="" alt="" />
                <div className="portfolio-icon">
                  <a
          ...
          <div className="grid-item branding">
            <div className="portfolio-box-01">
              ...
              <div className="portfolio-img">
                <img src="static/img/portfolio/teams.png" title="" alt="" />
                <div className="portfolio-icon">
                  <a
          ...
          <div className="grid-item product photoshop">
            <div className="portfolio-box-01">
              ...
              <div className="portfolio-img">
                <img src="static/img/portfolio/trading.png" title="" alt="" />
                <div className="portfolio-icon">
                  <a
          ...
          <div className="grid-item fashion">
            <div className="portfolio-box-01">
              ...
              <div className="portfolio-img">
                <img src="static/img/portfolio/bomberman.png" title="" alt="" />
                <div className="portfolio-icon">
                  <a
          ...
          <div className="grid-item fashion">
            <div className="portfolio-box-01">
              ...
              <div className="portfolio-img">
                <img src="static/img/portfolio/assembler.png" title="" alt="" />
                <div className="portfolio-icon">
                  <a
          ...
          <div className="grid-item fashion">
            <div className="portfolio-box-01">
              ...
              <div className="portfolio-img">
                <img src="static/img/portfolio/maze.png" title="" alt="" />
                <div className="portfolio-icon">
                  <a
